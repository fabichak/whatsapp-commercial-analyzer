...
| [x] | M1-T2 | Stage 1: load DB → conversations.jsonl | 4h | M1-T1 | $0 |
| [x] | M1-T3 | Stage 2: rapidfuzz dedupe | 3h | M1-T2 | $0 |
| [x] | M1-T4 | Stage 3: hand-curated `script.yaml` | 3h | M0-T3 | $0 |
...
| [x] | M2-S6-T3 | Stage 6 turnaround extraction (pure) | 3h | M2-S6-T2 | $0 |
| [x] | M2-S7-T1 | Stage 7 embedding + HDBSCAN | 4h | M2-S4-T2 | $0 |
| [x] | M2-S8-T1 | Stage 8 full report | 5h | M2-S7-T1, M2-S6-T3, M2-S5-T1 | $1.50 |
| [x] | M3-T2 | Prompt-tuning loop for Stage 6 (≥16/20) | 2–4h | M2-S6-T2 | $0.50 |
| [x] | M3-T3 | Full-corpus run | 1h | all M2 | $6–8 |
...
| M1-T2 | 2026-04-20 | `pytest tests/test_load.py -q` → 12 passed. Smoke: 334 chats, 14965 msgs (spec est 387 — DB uses WhatsApp LIDs, not E.164). `--chat-limit 5` → 5 long + 1341 short. `--phones-file` (2 LIDs) → 2 long, short file not written. |
| M1-T3 | — | — |
| M1-T4 | — | — |
| M1-T5 | — | — |
| M1-T6 | — | — |
